...
Same two questions as fd [reviewer.md](../../ruver-feature-delivery/nodes/reviewer.md),
...
Then the fd [tester.md](../../ruver-feature-delivery/nodes/tester.md)
...
[UI_DESIGN_SYSTEM.md](../../ruver-feature-delivery/UI_DESIGN_SYSTEM.md).

## Loops

`prove_fix_loops: 2`. Either verdict fail, or tester fail → **patch**
the same slice while loops remain. Last remaining slot: **fresh**
`ruver-fd-coder` (the previous one missed it). Exhaust → **escalate**.
