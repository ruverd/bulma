...
Canonical contract: [implement.md](implement.md). This file is the `bulma-fd-coder` prompt.
...
3. Spawn a **new** subagent (`bulma-fd-coder` / fresh Task).
...
Parent prompt = [bulma-host](../../bulma-host/SKILL.md) `spawn_worker`.
