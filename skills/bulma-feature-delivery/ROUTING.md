...
Triage-time `risk` is from the goal and ticket text. PR-diff risk is `../bulma-code-review/scripts/classify-risk.py` after there is a diff. Do not run that script here.
