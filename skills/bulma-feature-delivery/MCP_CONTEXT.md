...
Always at the start of `/bulma-fd`, **before** triage:
...
2. Run again: `/bulma-fd <same goal>`
```

Speak that block in the chat language (`bulma-memory`). Without this
...
Branch: [JOBS.md](../bulma-bus/JOBS.md) (`feature/<id-lowercase>`).
