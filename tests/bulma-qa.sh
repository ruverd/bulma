...
EXEC="$ROOT/skills/bulma-qa/references/EXECUTION.md"
COMMENT="$ROOT/skills/bulma-qa/references/COMMENT.md"
VERDICTS="$ROOT/skills/bulma-qa/references/VERDICTS.md"
BAA="$ROOT/skills/before-and-after/SKILL.md"
GATE="$ROOT/skills/bulma-qa/scripts/walk-video-gate.sh"
...
TMP="$(mktemp -d "${TMPDIR:-/tmp}/bulma-qa.XXXXXX")"
trap 'rm -rf "$TMP"' EXIT
...
VIDEO="$ROOT/skills/bulma-qa/references/VIDEO.md"
CONCAT="$ROOT/skills/bulma-qa/scripts/concat-clips.sh"
PLAN="$ROOT/skills/bulma-qa/references/PLAN.md"
TPL="$ROOT/skills/bulma-qa/templates/PLAN.md"
CMD="$ROOT/docs/commands/bulma-qa.md"
...
grep -qi 'clip' "$CMD" || fail "docs/commands/bulma-qa.md should mention clips, not one walk tape"
...
SKILL="$ROOT/skills/bulma-qa/SKILL.md"
GRAPH="$ROOT/skills/bulma-qa/GRAPH.md"
PRODUCT="$ROOT/skills/bulma-feature-delivery/PRODUCT.md"
REQ_QA="$ROOT/skills/bulma-developer/nodes/request_qa.md"
README="$ROOT/README.md"
PROOF="$ROOT/skills/bulma-qa/scripts/http-proof.sh"
